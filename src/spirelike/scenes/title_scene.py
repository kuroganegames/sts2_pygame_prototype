...
class TitleScene(BaseScene):
    ...
    def draw(self, surface) -> None:
        ...
        draw_text(surface, "SPIRELIKE", get_font(72, bold=True), colors.GOLD, (w // 2, 150), center=True)
        draw_text(surface, "Pygame / YAML-driven Deckbuilder Prototype", get_font(24), colors.MUTED, (w // 2, 220), center=True)
        rect = pygame.Rect(w // 2 - 330, 270, 660, 90)
        draw_wrapped(
            surface,
